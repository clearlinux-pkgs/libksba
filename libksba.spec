...
Source0  : https://gnupg.org/ftp/gcrypt/libksba/libksba-1.6.3.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/libksba/libksba-1.6.3.tar.bz2.sig
...
%prep
%setup -q -n libksba-1.6.3
cd %{_builddir}/libksba-1.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671560083
