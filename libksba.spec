...
Source0  : https://gnupg.org/ftp/gcrypt/libksba/libksba-1.6.7.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/libksba/libksba-1.6.7.tar.bz2.sig
...
%setup -q -n libksba-1.6.7
cd %{_builddir}/libksba-1.6.7
pushd ..
cp -a libksba-1.6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718981599
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libksba.so.8.14.7
/usr/lib64/libksba.so.8
/usr/lib64/libksba.so.8.14.7
